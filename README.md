...
* [Curator](https://github.com/bespokelabsai/curator) ⭐ 1,717 | 🐛 74 | 🌐 Python | 📅 2026-08-07 - Batch-inference and synthetic-data library; `batch=True` gives \~50% savings across OpenAI/Anthropic/Gemini/Mistral with built-in caching and retries. ![Stars](https://img.shields.io/github/stars/bespokelabsai/curator)
...
* [LiteLLM](https://github.com/BerriAI/litellm) ⭐ 56,956 | 🐛 5,063 | 🌐 Python | 📅 2026-08-21 - SDK + proxy for 100+ LLMs with routing, cost tracking. Strategies: least-busy, cost-based, latency-based. ![Stars](https://img.shields.io/github/stars/BerriAI/litellm)
* [Portkey AI Gateway](https://github.com/Portkey-AI/gateway) ⭐ 12,791 | 🐛 245 | 🌐 TypeScript | 📅 2026-05-25 - Open-source AI gateway routing to 1,600+ LLMs with guardrails, caching, and load balancing. Acquired by Palo Alto Networks (May 2026); gateway remains open-source under Apache 2.0. ![Stars](https://img.shields.io/github/stars/Portkey-AI/gateway)
* [Bifrost](https://github.com/maximhq/bifrost) ⭐ 7,485 | 🐛 932 | 🌐 Go | 📅 2026-08-21 - 50x faster than LiteLLM; adaptive load balancer, 1000+ models. ![Stars](https://img.shields.io/github/stars/maximhq/bifrost)
* [RouteLLM](https://github.com/lm-sys/RouteLLM) ⭐ 5,380 | 🐛 40 | 🌐 Python | 📅 2024-08-10 - Open-source LLM router by LMSYS. Trains routers from preference data; 2x+ cost reduction. **Note: last commit Aug 2024; LMSYS team shifted focus to Chatbot Arena.** ![Stars](https://img.shields.io/github/stars/lm-sys/RouteLLM)
* [vLLM Semantic Router](https://github.com/vllm-project/semantic-router) ⭐ 5,212 | 🐛 346 | 🌐 Go | 📅 2026-08-21 - System-level signal-driven router for Mixture-of-Models across cloud, data center, and edge. v0.3 "Themis" (June 2026); SAAR adds session-aware model selection cutting model switches 79% in multi-agent deployments. ![Stars](https://img.shields.io/github/stars/vllm-project/semantic-router)
* [LLMRouter](https://github.com/ulab-uiuc/LLMRouter) ⭐ 2,448 | 🐛 35 | 🌐 Python | 📅 2026-08-20 - Open-source routing library with 16+ routers (single-round, multi-turn, agentic, personalized) and a unified CLI. ![Stars](https://img.shields.io/github/stars/ulab-uiuc/LLMRouter)
...
* [RTK](https://github.com/rtk-ai/rtk) ⭐ 76,962 | 🐛 1,986 | 🌐 Rust | 📅 2026-08-21 - Single-binary Rust CLI proxy that compresses dev-command output 60-90% before it reaches a coding agent's context. Works with Claude Code, Cursor, Copilot, Gemini CLI. ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk)
* [Headroom](https://github.com/chopratejas/headroom) ⭐ 67,117 | 🐛 514 | 🌐 Python | 📅 2026-08-21 - Compress tool outputs, logs, files, and RAG chunks before they reach the LLM (60-95% fewer tokens); library, proxy, and MCP server. Claude Code/Cursor/Aider compatible.
* [TOON](https://github.com/toon-format/toon) ⭐ 25,217 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-07 - Token-Oriented Object Notation: a compact, schema-aware encoding for passing JSON-like data to LLMs; 30-60% fewer tokens than JSON on uniform arrays of objects. ![Stars](https://img.shields.io/github/stars/toon-format/toon)
* [code2prompt](https://github.com/mufeedvh/code2prompt) ⭐ 7,607 | 🐛 21 | 🌐 Rust | 📅 2026-06-29 - Codebase to LLM prompt with token counting. ![Stars](https://img.shields.io/github/stars/mufeedvh/code2prompt)
* [LLMLingua](https://github.com/microsoft/LLMLingua) ⭐ 6,592 | 🐛 119 | 🌐 Python | 📅 2026-04-08 - Up to 20x compression. Coarse-to-fine iterative method. Integrates with LangChain/LlamaIndex. ![Stars](https://img.shields.io/github/stars/microsoft/LLMLingua)
* [lean-ctx](https://github.com/yvgude/lean-ctx) ⭐ 3,626 | 🐛 20 | 🌐 Rust | 📅 2026-08-21 - Rust binary context intelligence layer for AI coding agents; 60-90% fewer tokens via shell-output compression and 10 cached-read modes; MCP server with 76 tools and cross-session memory. Works with Claude Code, Cursor, Copilot, Windsurf, Gemini CLI, and 30+ others. ![Stars](https://img.shields.io/github/stars/yvgude/lean-ctx)
...
* [Awesome LLM Compression](https://github.com/HuangOwen/Awesome-LLM-Compression) ⭐ 1,863 | 🐛 2 | 📅 2026-06-30 - Curated paper list.
...
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 89,656 | 🐛 6,889 | 🌐 Python | 📅 2026-08-21 - PagedAttention, high-throughput inference. ![Stars](https://img.shields.io/github/stars/vllm-project/vllm)
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 32,238 | 🐛 4,963 | 🌐 Python | 📅 2026-08-21 - RadixAttention for automatic KV cache reuse. ![Stars](https://img.shields.io/github/stars/sgl-project/sglang)
* [NVIDIA Dynamo](https://github.com/ai-dynamo/dynamo) ⭐ 7,818 | 🐛 1,252 | 🌐 Rust | 📅 2026-08-21 - Datacenter-scale distributed inference with KV-cache-aware routing and disaggregated prefill/decode; \~2x faster TTFT, 7x throughput/GPU. ![Stars](https://img.shields.io/github/stars/ai-dynamo/dynamo)
* [Mooncake](https://github.com/kvcache-ai/Mooncake) ⭐ 6,337 | 🐛 479 | 🌐 C++ | 📅 2026-08-21 - Distributed KVCache engine (the serving platform behind Moonshot AI's Kimi); integrated into vLLM for high-bandwidth KV-cache transfer and cross-instance prefix reuse across disaggregated prefill/decode. ![Stars](https://img.shields.io/github/stars/kvcache-ai/Mooncake)
* [GPUStack](https://github.com/gpustack/gpustack) ⭐ 5,535 | 🐛 684 | 🌐 Python | 📅 2026-08-21 - GPU cluster manager for vLLM/SGLang. ![Stars](https://img.shields.io/github/stars/gpustack/gpustack)
* [llm-d](https://github.com/llm-d/llm-d) ⭐ 4,093 | 🐛 203 | 🌐 Shell | 📅 2026-08-21 - Kubernetes-native distributed serving with prefix-cache-aware routing and tiered KV offload to CPU/disk (3x output throughput). ![Stars](https://img.shields.io/github/stars/llm-d/llm-d)

### Compression Tools

* [LMCache](https://github.com/LMCache/LMCache) ⭐ 11,299 | 🐛 566 | 🌐 Python | 📅 2026-08-21 - KV cache layer for vLLM/SGLang; offloads and reuses caches across engines (CPU/disk/S3) to cut TTFT for long-context, multi-turn, and RAG. ![Stars](https://img.shields.io/github/stars/LMCache/LMCache)
* [DeepSpec](https://github.com/deepseek-ai/DeepSpec) ⭐ 7,013 | 🐛 59 | 🌐 Python | 📅 2026-07-09 - DeepSeek's open-source speculative decoding stack powering DSpark; 60-85% faster on V4-Flash, 57-78% on V4-Pro; outperforms Eagle-3. MIT license. ![Stars](https://img.shields.io/github/stars/deepseek-ai/DeepSpec)
* [aibrix](https://github.com/vllm-project/aibrix) ⭐ 5,026 | 🐛 371 | 🌐 Go | 📅 2026-08-21 - Cost-efficient infrastructure for GenAI inference. ![Stars](https://img.shields.io/github/stars/vllm-project/aibrix)
* [llm-compressor](https://github.com/vllm-project/llm-compressor) ⭐ 3,709 | 🐛 138 | 🌐 Python | 📅 2026-08-21 - Compression for deployment with vLLM. ![Stars](https://img.shields.io/github/stars/vllm-project/llm-compressor)
* [NVIDIA Model Optimizer](https://github.com/NVIDIA/Model-Optimizer) ⭐ 3,464 | 🐛 358 | 🌐 Python | 📅 2026-08-21 - Quantization, pruning, distillation, speculative decoding. ![Stars](https://img.shields.io/github/stars/NVIDIA/Model-Optimizer)
...
* [NVIDIA kvpress](https://github.com/NVIDIA/kvpress) ⭐ 1,179 | 🐛 7 | 🌐 Python | 📅 2026-08-18 - KV cache compression made easy. ![Stars](https://img.shields.io/github/stars/NVIDIA/kvpress)
* [kvcached](https://github.com/ovg-project/kvcached) ⭐ 1,140 | 🐛 99 | 🌐 Python | 📅 2026-08-20 - Virtualized elastic KV cache decoupling virtual/physical GPU memory for dynamic GPU sharing; plugs into vLLM/SGLang. ![Stars](https://img.shields.io/github/stars/ovg-project/kvcached)
...
* [mini-sglang](https://github.com/sgl-project/mini-sglang) ⭐ 4,785 | 🐛 50 | 🌐 Python | 📅 2026-05-17 - Learn LLM serving internals.
* [tiny-llm](https://github.com/skyzh/tiny-llm) ⭐ 4,512 | 🐛 8 | 🌐 Python | 📅 2026-08-18 - Build a tiny vLLM on Apple Silicon.
...
| Playwright MCP   | \~10-33 KB (accessibility tree) | Baseline                                                                              | [GitHub](https://github.com/microsoft/playwright-mcp) ⭐ 36,337 \| 🐛 2 \| 🌐 TypeScript \| 📅 2026-08-20 |
| Agent Browser ⚠️ | \~28 KB (accessibility tree)    | Project unmaintained 2026-05 — superseded by browser-use direct mode + Playwright MCP | [GitHub](https://github.com/vercel-labs/agent-browser) ⭐ 41,097 \| 🐛 662 \| 🌐 Rust \| 📅 2026-08-21    |
| Lightpanda       | \~16 KB (raw markdown)          | 2x better                                                                             | [GitHub](https://github.com/lightpanda-io/browser) ⭐ 34,179 \| 🐛 94 \| 🌐 Zig \| 📅 2026-08-21          |
...
* [browser-use](https://github.com/browser-use/browser-use) ⭐ 110,017 | 🐛 364 | 🌐 Python | 📅 2026-08-21 - Foundation library for AI browser agents.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 33,529 | 🐛 812 | 🌐 TypeScript | 📅 2026-08-21 - Open-source LLM observability + cost tracking. [Cost tracking docs](https://langfuse.com/docs/observability/features/token-and-cost-tracking). Acquired by ClickHouse (Jan 2026); still actively developed, MIT-licensed. ![Stars](https://img.shields.io/github/stars/langfuse/langfuse)
* [MLflow](https://github.com/mlflow/mlflow) ⭐ 27,610 | 🐛 2,065 | 🌐 Python | 📅 2026-08-21 - Open-source AI/ML platform with GenAI observability in MLflow 3.x: LLM call tracing with per-span token tracking, prompt optimization tooling, and AI Gateway integration for cost control. ![Stars](https://img.shields.io/github/stars/mlflow/mlflow)
* [tiktoken](https://github.com/openai/tiktoken) ⭐ 19,059 | 🐛 128 | 🌐 Python | 📅 2026-08-17 - OpenAI's fast BPE tokenizer (Python/Rust), 3-6x faster.
* [ccusage](https://github.com/ryoppippi/ccusage) ⭐ 18,094 | 🐛 29 | 🌐 Rust | 📅 2026-08-21 - Fast local CLI reporting tokens and cost across 14+ coding agents (Claude Code, Codex, Gemini CLI, Copilot); offline, no upload. ![Stars](https://img.shields.io/github/stars/ryoppippi/ccusage)
* [OpenLLMetry](https://github.com/traceloop/openllmetry) ⭐ 7,387 | 🐛 655 | 🌐 Python | 📅 2026-08-10 - OpenTelemetry-based GenAI observability instrumenting LLM and vector-DB calls with per-call token and latency telemetry. ![Stars](https://img.shields.io/github/stars/traceloop/openllmetry)
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,093 | 🐛 149 | 🌐 TypeScript | 📅 2026-08-16 - LLM observability, 300+ models, SOC 2. [Cost tracking cookbook](https://docs.helicone.ai/guides/cookbooks/cost-tracking). Acquired by Mintlify (Mar 2026); now maintenance-only — security/bug fixes and new-model support continue, no new feature work. ![Stars](https://img.shields.io/github/stars/Helicone/helicone)
* [AgentOps](https://github.com/AgentOps-AI/agentops) ⭐ 5,789 | 🐛 175 | 🌐 Python | 📅 2026-06-25 - Agent monitoring with LLM cost tracking. ![Stars](https://img.shields.io/github/stars/AgentOps-AI/agentops)
...
* [Anthropic Interactive Tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial) ⭐ 37,747 | 🐛 63 | 🌐 Jupyter Notebook | 📅 2026-03-01 - 9-chapter course.
...
* [LLM Safe Haven](https://github.com/pleasedodisturb/llm-safe-haven) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-21 - Security toolkit for AI coding agents. `npx llm-safe-haven` hardens Claude Code, Cursor, Windsurf in 60 seconds. Companion project — agent retries from security failures waste tokens.
