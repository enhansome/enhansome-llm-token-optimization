...
* [autocache](https://github.com/montevive/autocache) ⭐ 169 | 🐛 2 | 🌐 Go | 📅 2026-02-02 - Transparent Anthropic proxy that auto-injects `cache_control` breakpoints at optimal positions; up to 90% cost and 85% latency reduction. ![Stars](https://img.shields.io/github/stars/montevive/autocache)

## Batch APIs

50% discounts for non-time-critical requests. Combine with caching for 95% savings.

* [Curator](https://github.com/bespokelabsai/curator) ⭐ 1,722 | 🐛 74 | 🌐 Python | 📅 2026-08-07 - Batch-inference and synthetic-data library; `batch=True` gives \~50% savings across OpenAI/Anthropic/Gemini/Mistral with built-in caching and retries. ![Stars](https://img.shields.io/github/stars/bespokelabsai/curator)
...
* [LiteLLM](https://github.com/BerriAI/litellm) ⭐ 57,773 | 🐛 4,872 | 🌐 Python | 📅 2026-09-02 - SDK + proxy for 100+ LLMs with routing, cost tracking. Strategies: least-busy, cost-based, latency-based. ![Stars](https://img.shields.io/github/stars/BerriAI/litellm)
* [Portkey AI Gateway](https://github.com/Portkey-AI/gateway) ⭐ 12,872 | 🐛 253 | 🌐 TypeScript | 📅 2026-05-25 - Open-source AI gateway routing to 1,600+ LLMs with guardrails, caching, and load balancing. Acquired by Palo Alto Networks (May 2026); gateway remains open-source under Apache 2.0. ![Stars](https://img.shields.io/github/stars/Portkey-AI/gateway)
* [Bifrost](https://github.com/maximhq/bifrost) ⭐ 7,738 | 🐛 1,002 | 🌐 Go | 📅 2026-09-01 - 50x faster than LiteLLM; adaptive load balancer, 1000+ models. ![Stars](https://img.shields.io/github/stars/maximhq/bifrost)
* [vLLM Semantic Router](https://github.com/vllm-project/semantic-router) ⭐ 5,479 | 🐛 393 | 🌐 Go | 📅 2026-09-01 - System-level signal-driven router for Mixture-of-Models across cloud, data center, and edge. v0.3 "Themis" (June 2026); SAAR adds session-aware model selection cutting model switches 79% in multi-agent deployments. ![Stars](https://img.shields.io/github/stars/vllm-project/semantic-router)
* [RouteLLM](https://github.com/lm-sys/RouteLLM) ⭐ 5,435 | 🐛 41 | 🌐 Python | 📅 2024-08-10 - Open-source LLM router by LMSYS. Trains routers from preference data; 2x+ cost reduction. **Note: last commit Aug 2024; LMSYS team shifted focus to Chatbot Arena.** ![Stars](https://img.shields.io/github/stars/lm-sys/RouteLLM)
* [LLMRouter](https://github.com/ulab-uiuc/LLMRouter) ⭐ 2,737 | 🐛 39 | 🌐 Python | 📅 2026-08-20 - Open-source routing library with 16+ routers (single-round, multi-turn, agentic, personalized) and a unified CLI. ![Stars](https://img.shields.io/github/stars/ulab-uiuc/LLMRouter)
...
* [RTK](https://github.com/rtk-ai/rtk) ⭐ 78,223 | 🐛 2,060 | 🌐 Rust | 📅 2026-09-01 - Single-binary Rust CLI proxy that compresses dev-command output 60-90% before it reaches a coding agent's context. Works with Claude Code, Cursor, Copilot, Gemini CLI. ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk)
* [Headroom](https://github.com/chopratejas/headroom) ⭐ 68,329 | 🐛 601 | 🌐 Python | 📅 2026-09-01 - Compress tool outputs, logs, files, and RAG chunks before they reach the LLM (60-95% fewer tokens); library, proxy, and MCP server. Claude Code/Cursor/Aider compatible.
* [TOON](https://github.com/toon-format/toon) ⭐ 25,298 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-31 - Token-Oriented Object Notation: a compact, schema-aware encoding for passing JSON-like data to LLMs; 30-60% fewer tokens than JSON on uniform arrays of objects. ![Stars](https://img.shields.io/github/stars/toon-format/toon)
* [code2prompt](https://github.com/mufeedvh/code2prompt) ⭐ 7,621 | 🐛 21 | 🌐 Rust | 📅 2026-06-29 - Codebase to LLM prompt with token counting. ![Stars](https://img.shields.io/github/stars/mufeedvh/code2prompt)
* [LLMLingua](https://github.com/microsoft/LLMLingua) ⭐ 6,619 | 🐛 120 | 🌐 Python | 📅 2026-04-08 - Up to 20x compression. Coarse-to-fine iterative method. Integrates with LangChain/LlamaIndex. ![Stars](https://img.shields.io/github/stars/microsoft/LLMLingua)
* [lean-ctx](https://github.com/yvgude/lean-ctx) ⭐ 3,696 | 🐛 8 | 🌐 Rust | 📅 2026-09-01 - Rust binary context intelligence layer for AI coding agents; 60-90% fewer tokens via shell-output compression and 10 cached-read modes; MCP server with 76 tools and cross-session memory. Works with Claude Code, Cursor, Copilot, Windsurf, Gemini CLI, and 30+ others. ![Stars](https://img.shields.io/github/stars/yvgude/lean-ctx)
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 222 | 🐛 9 | 🌐 Rust | 📅 2026-09-01 - Quality-gated local proxy and MCP server that compresses prompts, tool outputs, and replies before they reach the LLM, reverting any step that doesn't save tokens (project-reported -31% input / -74% output across 112 A/B cases). Rust CLI plus multi-language library bindings and a WebAssembly/JS package. ![Stars](https://img.shields.io/github/stars/fkiene/llmtrim)
...
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 90,703 | 🐛 7,320 | 🌐 Python | 📅 2026-09-01 - PagedAttention, high-throughput inference. ![Stars](https://img.shields.io/github/stars/vllm-project/vllm)
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 33,058 | 🐛 5,041 | 🌐 Python | 📅 2026-09-02 - RadixAttention for automatic KV cache reuse. ![Stars](https://img.shields.io/github/stars/sgl-project/sglang)
* [NVIDIA Dynamo](https://github.com/ai-dynamo/dynamo) ⭐ 7,944 | 🐛 1,342 | 🌐 Rust | 📅 2026-09-02 - Datacenter-scale distributed inference with KV-cache-aware routing and disaggregated prefill/decode; \~2x faster TTFT, 7x throughput/GPU. ![Stars](https://img.shields.io/github/stars/ai-dynamo/dynamo)
* [Mooncake](https://github.com/kvcache-ai/Mooncake) ⭐ 6,460 | 🐛 544 | 🌐 C++ | 📅 2026-09-01 - Distributed KVCache engine (the serving platform behind Moonshot AI's Kimi); integrated into vLLM for high-bandwidth KV-cache transfer and cross-instance prefix reuse across disaggregated prefill/decode. ![Stars](https://img.shields.io/github/stars/kvcache-ai/Mooncake)
* [GPUStack](https://github.com/gpustack/gpustack) ⭐ 5,582 | 🐛 688 | 🌐 Python | 📅 2026-09-01 - GPU cluster manager for vLLM/SGLang. ![Stars](https://img.shields.io/github/stars/gpustack/gpustack)
* [llm-d](https://github.com/llm-d/llm-d) ⭐ 4,380 | 🐛 222 | 🌐 Shell | 📅 2026-09-01 - Kubernetes-native distributed serving with prefix-cache-aware routing and tiered KV offload to CPU/disk (3x output throughput). ![Stars](https://img.shields.io/github/stars/llm-d/llm-d)

### Compression Tools

* [LMCache](https://github.com/LMCache/LMCache) ⭐ 11,611 | 🐛 610 | 🌐 Python | 📅 2026-09-02 - KV cache layer for vLLM/SGLang; offloads and reuses caches across engines (CPU/disk/S3) to cut TTFT for long-context, multi-turn, and RAG. ![Stars](https://img.shields.io/github/stars/LMCache/LMCache)
* [DeepSpec](https://github.com/deepseek-ai/DeepSpec) ⭐ 7,064 | 🐛 61 | 🌐 Python | 📅 2026-07-09 - DeepSeek's open-source speculative decoding stack powering DSpark; 60-85% faster on V4-Flash, 57-78% on V4-Pro; outperforms Eagle-3. MIT license. ![Stars](https://img.shields.io/github/stars/deepseek-ai/DeepSpec)
* [aibrix](https://github.com/vllm-project/aibrix) ⭐ 5,051 | 🐛 377 | 🌐 Go | 📅 2026-09-01 - Cost-efficient infrastructure for GenAI inference. ![Stars](https://img.shields.io/github/stars/vllm-project/aibrix)
* [llm-compressor](https://github.com/vllm-project/llm-compressor) ⭐ 3,748 | 🐛 137 | 🌐 Python | 📅 2026-09-01 - Compression for deployment with vLLM. ![Stars](https://img.shields.io/github/stars/vllm-project/llm-compressor)
* [NVIDIA Model Optimizer](https://github.com/NVIDIA/Model-Optimizer) ⭐ 3,675 | 🐛 374 | 🌐 Python | 📅 2026-09-02 - Quantization, pruning, distillation, speculative decoding. ![Stars](https://img.shields.io/github/stars/NVIDIA/Model-Optimizer)
* [kvcached](https://github.com/ovg-project/kvcached) ⭐ 1,228 | 🐛 110 | 🌐 Python | 📅 2026-08-23 - Virtualized elastic KV cache decoupling virtual/physical GPU memory for dynamic GPU sharing; plugs into vLLM/SGLang. ![Stars](https://img.shields.io/github/stars/ovg-project/kvcached)
...
* [NVIDIA kvpress](https://github.com/NVIDIA/kvpress) ⭐ 1,198 | 🐛 5 | 🌐 Python | 📅 2026-09-01 - KV cache compression made easy. ![Stars](https://img.shields.io/github/stars/NVIDIA/kvpress)
...
* [Awesome KV Cache Compression](https://github.com/October2001/Awesome-KV-Cache-Compression) ⭐ 736 | 🐛 5 | 📅 2026-08-16 - Must-read paper list.

*The full KV-cache paper table lives in the Academic Papers section below.*

### Educational

* [mini-sglang](https://github.com/sgl-project/mini-sglang) ⭐ 4,929 | 🐛 50 | 🌐 Python | 📅 2026-05-17 - Learn LLM serving internals.
* [tiny-llm](https://github.com/skyzh/tiny-llm) ⭐ 4,535 | 🐛 7 | 🌐 Python | 📅 2026-08-31 - Build a tiny vLLM on Apple Silicon.
...
| Playwright MCP   | \~10-33 KB (accessibility tree) | Baseline                                                                              | [GitHub](https://github.com/microsoft/playwright-mcp) ⭐ 36,715 \| 🐛 1 \| 🌐 TypeScript \| 📅 2026-09-01 |
| Agent Browser ⚠️ | \~28 KB (accessibility tree)    | Project unmaintained 2026-05 — superseded by browser-use direct mode + Playwright MCP | [GitHub](https://github.com/vercel-labs/agent-browser) ⭐ 41,715 \| 🐛 677 \| 🌐 Rust \| 📅 2026-09-01    |
| Lightpanda       | \~16 KB (raw markdown)          | 2x better                                                                             | [GitHub](https://github.com/lightpanda-io/browser) ⭐ 34,367 \| 🐛 102 \| 🌐 Zig \| 📅 2026-09-02         |
...
* [browser-use](https://github.com/browser-use/browser-use) ⭐ 111,977 | 🐛 399 | 🌐 Python | 📅 2026-09-01 - Foundation library for AI browser agents.
* [mcp-compressor](https://github.com/atlassian-labs/mcp-compressor) ⭐ 116 | 🐛 5 | 🌐 Rust | 📅 2026-08-31 - MCP proxy that shows a compressed tool surface first and fetches full schemas on demand, cutting tokens spent on large MCP tool descriptions. ![Stars](https://img.shields.io/github/stars/atlassian-labs/mcp-compressor)
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 34,058 | 🐛 875 | 🌐 TypeScript | 📅 2026-09-01 - Open-source LLM observability + cost tracking. [Cost tracking docs](https://langfuse.com/docs/observability/features/token-and-cost-tracking). Acquired by ClickHouse (Jan 2026); still actively developed, MIT-licensed. ![Stars](https://img.shields.io/github/stars/langfuse/langfuse)
* [MLflow](https://github.com/mlflow/mlflow) ⭐ 27,768 | 🐛 2,052 | 🌐 Python | 📅 2026-09-02 - Open-source AI/ML platform with GenAI observability in MLflow 3.x: LLM call tracing with per-span token tracking, prompt optimization tooling, and AI Gateway integration for cost control. ![Stars](https://img.shields.io/github/stars/mlflow/mlflow)
* [tiktoken](https://github.com/openai/tiktoken) ⭐ 19,142 | 🐛 129 | 🌐 Python | 📅 2026-08-17 - OpenAI's fast BPE tokenizer (Python/Rust), 3-6x faster.
* [ccusage](https://github.com/ryoppippi/ccusage) ⭐ 18,281 | 🐛 14 | 🌐 Rust | 📅 2026-09-01 - Fast local CLI reporting tokens and cost across 14+ coding agents (Claude Code, Codex, Gemini CLI, Copilot); offline, no upload. ![Stars](https://img.shields.io/github/stars/ryoppippi/ccusage)
* [OpenLLMetry](https://github.com/traceloop/openllmetry) ⭐ 7,410 | 🐛 665 | 🌐 Python | 📅 2026-08-10 - OpenTelemetry-based GenAI observability instrumenting LLM and vector-DB calls with per-call token and latency telemetry. ![Stars](https://img.shields.io/github/stars/traceloop/openllmetry)
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,122 | 🐛 154 | 🌐 TypeScript | 📅 2026-08-31 - LLM observability, 300+ models, SOC 2. [Cost tracking cookbook](https://docs.helicone.ai/guides/cookbooks/cost-tracking). Acquired by Mintlify (Mar 2026); now maintenance-only — security/bug fixes and new-model support continue, no new feature work. ![Stars](https://img.shields.io/github/stars/Helicone/helicone)
* [AgentOps](https://github.com/AgentOps-AI/agentops) ⭐ 5,806 | 🐛 175 | 🌐 Python | 📅 2026-06-25 - Agent monitoring with LLM cost tracking. ![Stars](https://img.shields.io/github/stars/AgentOps-AI/agentops)
* [tokencost](https://github.com/AgentOps-AI/tokencost) ⭐ 2,006 | 🐛 31 | 🌐 Python | 📅 2025-09-05 - USD cost estimates for 400+ LLMs. ![Stars](https://img.shields.io/github/stars/AgentOps-AI/tokencost)
...
* [Anthropic Interactive Tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial) ⭐ 38,003 | 🐛 64 | 🌐 Jupyter Notebook | 📅 2026-08-28 - 9-chapter course.
